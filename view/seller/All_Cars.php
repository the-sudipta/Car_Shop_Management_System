...
<!--        Dynamic Search by using PHP and Javascript and Ajax-->



        <div class="container">
            <input type="search" class="form-control mb-3" id="datatable-search-input" placeholder="Search...">
        </div>

        <div class="container table-container">
            <h2 id="table_name">All Cars</h2>
            ...
            <script>
                document.getElementById('datatable-search-input').addEventListener('input', (e) => {
                    ...
                    const rows = document.querySelectorAll('#car-list tr');
                    ...
                    rows.forEach(row => {
                        ...
                        const availability = row.querySelector('td:nth-child(6)').textContent.toLowerCase();

                        const containsSearchTerm = id.includes(searchTerm) || brand.includes(searchTerm) || model.includes(searchTerm) || price.includes(searchTerm) || status.includes(searchTerm) || availability.includes(searchTerm);
